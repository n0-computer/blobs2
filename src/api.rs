...
pub mod blobs {
    ...
    use crate::{
        api::bitfield::Bitfield, store::util::observer::Aggregator, util::temp_tag::TempTag,
...
impl Store {
    ...
    pub async fn listen(self, endpoint: quinn::Endpoint) {
        ...
        let handler: Handler<Request> = Arc::new(move |req, _, tx| {
